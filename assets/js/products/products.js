    ...
    <div class="products__filter">
      <div class="filter">
        <div class="filter__header">
          ...
          <button class="filter__clear filter__clear-all" data-bs-dismiss="modal" aria-label="Close">Clear all</button>
        </div>

        <div class="filter__label">
          <p class="filter__title">Thương hiệu</p>
          <button class="filter__clear filter__clear-brand" data-bs-dismiss="modal" aria-label="Close">Clear</button>
        </div>

        <div class="filter__list">
          <button class="filter__item filter__item-brand" data-brand="" data-bs-dismiss="modal" aria-label="Close">Tất cả</button>
          ${brandList
            .map(
              (brand) => `
            <button class="filter__item filter__item-brand" data-brand="${brand}" data-bs-dismiss="modal" aria-label="Close">${brand}</button>
          `,
            )
            .join("")}
        </div>
        ...
        <div class="filter__label">
          ...
          <button class="filter__clear filter__clear-gender" data-bs-dismiss="modal" aria-label="Close">Clear</button>
        </div>

        <div class="filter__list">
          <button class="filter__item filter__item-gender" data-gender="" data-bs-dismiss="modal" aria-label="Close">Tất cả</button>
          ${genderList
            .map(
              (gender) => `
            <button class="filter__item filter__item-gender" data-gender="${gender}" data-bs-dismiss="modal" aria-label="Close">${gender}</button>
          `,
            )
            .join("")}
        </div>
        ...
        <div class="filter__label">
          ...
          <button class="filter__clear filter__clear-price" data-bs-dismiss="modal" aria-label="Close">Clear</button>
        </div>

        <div class="filter__list">
          <button class="filter__item filter__item-price" data-price-start="" data-price-end="" data-bs-dismiss="modal" aria-label="Close">Tất cả</button>
          <button class="filter__item filter__item-price" data-price-start="0" data-price-end="1000000" data-bs-dismiss="modal" aria-label="Close">Dưới 1 triệu</button>
          <button class="filter__item filter__item-price" data-price-start="1000000" data-price-end="2000000" data-bs-dismiss="modal" aria-label="Close">Từ 1 đến 2 triệu</button>
          <button class="filter__item filter__item-price" data-price-start="2000000" data-price-end="4000000" data-bs-dismiss="modal" aria-label="Close">Từ 2 đến 4 triệu</button>
          <button class="filter__item filter__item-price" data-price-start="4000000" data-price-end="Infinity" data-bs-dismiss="modal" aria-label="Close">Trên 4 triệu</button>
        </div>

        <div class="filter__label">
          <p class="filter__title">Tags</p>
          <button class="filter__clear filter__clear-tags" data-bs-dismiss="modal" aria-label="Close">Clear</button>
        </div>

        <div class="filter__list filter__list-tags">
          <button class="filter__item filter__item-tag" data-tag="" data-bs-dismiss="modal" aria-label="Close">Tất cả</button>
          ${tagList
            .map(
              (tag) => `
